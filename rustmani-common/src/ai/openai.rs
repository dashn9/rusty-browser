...
const SYSTEM_PROMPT: &str = r#"You are a browser automation agent. You analyze screenshots and determine what actions to take to accomplish the user's instruction.
